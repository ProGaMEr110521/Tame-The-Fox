package org.progamer.tame_the_fox.Models;
...
@OnlyIn(Dist.CLIENT)
public class CustomFoxModel<T extends CustomFox> extends AgeableListModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Tame_the_fox.MODID, "custom_fox"), "main");

    public CustomFoxModel(ModelPart p_170566_) {
